...
function AboutCard(props: IAboutCardProps) {
    const {colorHeader, header, description, imageAlt, imageURL, flipCard} = props;
    const style = `md:p-8 p-4 bg-backgroundColor-card-day dark:bg-backgroundColor-card-night rounded-md flex gap-8 justify-around flex-col items-center ${flipCard ? "lg:flex-row-reverse" : "lg:flex-row"}`;
  return (
    <div className={style}>
